(function($){
    ...
    App.module.controller("forms", function($scope, $rootScope, $http, $timeout){
        ...
        $http.post(App.route("/api/advancedforms/find"), {extended: true}).success(function(data){
        ...
        $scope.remove = function(index, form){
            ...
            App.Ui.confirm(App.i18n.get("Are you sure?"), function(){
                ...
                $http.post(App.route("/api/advancedforms/remove"), { "form": angular.copy(form) }, {responseType:"json"}).success(function(data){
