@start('header')
    ...
    {{ $app->assets(['advancedforms:assets/forms.js','advancedforms:assets/js/index.js'], $app['cockpit/version']) }}
...
<div data-ng-controller="forms" ng-cloak>
    ...
    <nav class="uk-navbar uk-margin-large-bottom">
        <span class="uk-hidden-small uk-navbar-brand">@lang('Advanced Forms')</span>
        ...
        <ul class="uk-navbar-nav">
            <li><a href="@route('/advancedforms/form')" title="@lang('Add form')" data-uk-tooltip="{pos:'right'}"><i class="uk-icon-plus-circle"></i></a></li>
        </ul>
        @end
    ...
    <div class="uk-grid uk-grid-small" data-uk-grid-match data-ng-if="forms && forms.length && mode=='list'">
        <div class="uk-width-1-1 uk-width-medium-1-3 uk-width-large-1-4 uk-grid-margin" data-ng-repeat="form in forms track by form._id" data-ng-show="matchName(form.name)">
            ...
            <div class="app-panel">
                ...
                <a class="uk-link-muted" href="@route('/advancedforms/entries')/@@ form._id @@"><strong>@@ form.name @@</strong></a>
                    ...
                    <div class="uk-link" data-uk-dropdown="{mode:'click'}">
                        ...
                        <div class="uk-dropdown">
                            <ul class="uk-nav uk-nav-dropdown uk-nav-parent-icon">
                                <li><a href="@route('/advancedforms/entries')/@@ form._id @@"><i class="uk-icon-list"></i> @lang('Show entries')</a></li>
                                @hasaccess?("AdvancedForms", 'manage.forms')
                                <li class="uk-nav-divider"></li>
                                <li><a href="@route('/advancedforms/form')/@@ form._id @@"><i class="uk-icon-pencil"></i> @lang('Edit form')</a></li>
        ...
        <table class="uk-table uk-table-striped" multiple-select="{model:forms}">
            ...
            <tbody>
                <tr class="js-multiple-select" data-ng-repeat="form in forms track by form._id" data-ng-show="matchName(form.name)">
                    ...
                    <td>
                        <a href="@route('/advancedforms/entries')/@@ form._id @@">@@ form.name @@</a>
                    </td>
                    <td>@@ form.count @@</td>
                    <td>
    ...
    <div class="uk-text-center app-panel" data-ng-show="forms && !forms.length">
        ...
        @hasaccess?("AdvancedForms", 'manage.forms')
        <a href="@route('/advancedforms/form')" class="uk-button uk-button-success uk-button-large">@lang('Create a form')</a>
        @end
    </div>
