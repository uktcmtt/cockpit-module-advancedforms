@start('header')
    ...
    {{ $app->assets(['advancedforms:assets/forms.js','advancedforms:assets/js/entries.js'], $app['cockpit/version']) }}
...
<div data-ng-controller="entries" ng-cloak>
    ...
    <nav class="uk-navbar uk-margin-bottom">
        <span class="uk-navbar-brand"><a href="@route("/advancedforms")">@lang('Forms')</a> / {{ $form['name'] }}</span>
        @hasaccess?("AdvancedForms", 'manage.forms')
        <ul class="uk-navbar-nav">
            <li><a href="@route('/advancedforms/form/'.$form["_id"])" title="@lang('Edit form')" data-uk-tooltip="{pos:'bottom'}"><i class="uk-icon-pencil"></i></a></li>
        ...
        <div class="uk-navbar-flip">
            ...
            <div class="uk-navbar-content" data-ng-show="entries && entries.length">
                <a class="uk-button" href="@route('/api/advancedforms/export/'.$form['_id'])" download="{{ $form['name'] }}.json" title="@lang('Export data')" data-uk-tooltip="{pos:'bottom'}">
                        ...
                        <tr class="js-multiple-select" data-ng-repeat="entry in entries track by entry._id">
                            ...
                            <td>
                                <div class="uk-grid uk-grid-preserve uk-text-small" data-ng-repeat="(key, value) in entry.data">
                                    ...
                                    <div class="uk-width-medium-4-5" ng-if="value.filename">
                                       <a href="@@ value.link @@" target="_blank">@@ value.filename @@</a>
                                    </div>
                                    <div class="uk-width-medium-4-5" ng-if="!value.filename">
                                       @@ value @@
                                    </div>
